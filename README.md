...
Este es el microservicio de Despachos para la plataforma de Innovatech Chile. Fue construido usando Java y Spring Boot.
...
El proyecto está configurado para ejecutarse en el puerto **8081**.
...
2. Se compila la imagen Docker de Despachos.
